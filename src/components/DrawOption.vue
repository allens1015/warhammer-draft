...
<template>
  <button
    class="group/card relative aspect-[3/4] w-full overflow-hidden rounded-lg border border-border bg-neutral-200 text-left transition-transform hover:scale-[1.02] active:scale-[0.98]"
  ...
  >
    ...
    <div class="absolute bottom-0 left-0 right-0 p-4 text-white">
      ...
      <h3 class="font-medium leading-tight flex items-center gap-1.5">
